...
export default function HomePage () {
  return (
    <main className={montserratBold.className}>
      <div className='flex flex-col min-h-screen bg-gradient-to-b from-nonBlack to-liteBG items-center'>
        <NavigationMenu className='mt-4 top-0 lg:mx-auto '>
        ...
        <section className='flex w-full  bg-gradient-to-b from-transparent from 30% via-liteBG via-10% to-niceOrange to-90%  mt-[-15px] md:mt-[-10px] lg:mt-[-10px] pt-[100px] mb-[-50px]' />
        {/* Footer */}
        <FooterPeaks />
        <footer className='grid grid-cols-1 w-full place-items-center bg-boxLite md:space-x-7'>
          ...
          <div className='flex items-center justify-center bg-boxLite md:space-x-7'>
            ...
            <GithubIcon />
            <p
              className={`mb-3 text-baseBG text-[13px] md:text-md lg:text-lg ${montserratBold.className}`}
            >
