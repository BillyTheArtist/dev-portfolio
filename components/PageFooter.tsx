...
export function PageFooter () {
  return (
    <footer className='h-[177px]'>
      <span className='flex w-full bg-gradient-to-b from-transparent from 30% via-liteBG via-10% to-niceOrange to-90%  mt-[-15px] md:mt-[-80px] lg:mt-[-10px] pt-[100px] mb-[-50px] lg:mb-[-60px]' />
      <FooterPeaks />
